...
class Vehicle {
  constructor (public vin: number, public color: string, public make: string, public model: string, public year: number) {}
  printDetails(): void {
...
class Truck extends Vehicle implements AbleToTow {
  ...
  constructor(vin: number, color: string, make: string, model: string, year: number, weight: number, topSpeed: number, wheels: Wheel[], towingCapacity: number) {
